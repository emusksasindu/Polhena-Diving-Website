            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <h3>${{$product->selling_price}}/= <span>${{$product->selling_price *(100 + $product->discount)/100}}/=</span></h3>
                ...
                <div class="product__item {{$product->discount > 0? 'sale': ''}}">
                    ...
                    <div class="product__item__text">
                        ...
                        @if($relatedProduct->discount > 0)
                                <h5 class = "text-muted font-weight-light"><span>${{$relatedProduct->selling_price *(100 + $relatedProduct->discount)/100}}</span></h5>
                        @endif
